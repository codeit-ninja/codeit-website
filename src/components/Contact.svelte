            ...
            <div class="row">
                ...
                <div class="col-lg-7 offset-lg-1">
                    ...
                    <form on:submit|preventDefault={submit}>
                        <div class="mb-4">
                            <input type="text" class="form-control form-control-lg" placeholder="Naar welke naam luister je?" name="name" bind:value={$contact.name} required />
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <textarea class="form-control form-control-lg" placeholder="Vertel wat leuks, stel een vraag of vragen als je er meerdere hebt, of bied me koffie aan!" name="message" bind:value={$contact.message} rows="5" required></textarea>
                        </div>
